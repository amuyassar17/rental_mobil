...
//fungsi tampil created by Sigit Dwi Prasetyo
	function tampil($sql,$title,$field,$mobil)
	{
		//awal tabel
		echo "<table>";
		//baris judul kolom
		...
		//jika variabel mobil tidak kosong maka tampilkan kolom mobil
		if (!empty($mobil))
		{
			echo "<td colspan=2>mobil</td>";
		}
		echo "</tr>";
		//proses ke mysql
		$no=1;
